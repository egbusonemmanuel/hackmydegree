        ...
        <>
            <nav className="glass" style={{
                ...
                <div className="mobile-only" style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                    ...
                    <button onClick={toggleMenu} aria-label={isMenuOpen ? 'Close navigation menu' : 'Open navigation menu'} aria-expanded={isMenuOpen} style={{ background: 'none', border: 'none', color: 'var(--on-surface)', fontSize: '1.5rem', cursor: 'pointer' }}>
                        {isMenuOpen ? '✕' : '☰'}
                    </button>
                </div>
            </nav>
