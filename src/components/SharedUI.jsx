...
export const SparklesIcon = ({ size = 18, color = 'currentColor', ...props }) => (
...
export const BookOpenIcon = ({ size = 18, color = 'currentColor', ...props }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const AcademicCapIcon = ({ size = 18, color = 'currentColor', ...props }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const TrendingUpIcon = ({ size = 18, color = 'currentColor', ...props }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const VideoCameraIcon = ({ size = 18, color = 'currentColor', ...props }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const GlobeAltIcon = ({ size = 18, color = 'currentColor', ...props }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const CheckBadgeIcon = ({ size = 18, color = 'currentColor', ...props }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 2l3.09 3.26 4.41.64-1.25 4.3 2.75 3.53-3.6 2.68-.64 4.41-4.41-1.25L9 22l-3.09-3.26-4.41-.64 1.25-4.3L0 10.27l3.6-2.68.64-4.41 4.41 1.25L12 2z" />
        <path d="m9 12 2 2 4-4" />
    </svg>
);

export const StarIcon = ({ size = 16, color = '#E5A83B', filled = true, ...props }) => (
...
export const WhatsAppButton = ({ text, url = window.location.origin, compact = false, ...props }) => {
    ...
    if (compact) {
        return (
            <a
                ...
                style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', ...props.style }}
            >
                <button
                    style={{
                        ...
                        borderRadius: '100px',
                        fontFamily: 'var(--font-header)', fontWeight: 700, fontSize: '0.85rem',
    ...
    return (
        <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            style={{ textDecoration: 'none', display: 'block', width: '100%', ...props.style }}
        >
            <button
                style={{
                    width: '100%',
