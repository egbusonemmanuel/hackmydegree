        ...
        <div className="auth-split" style={{ display: 'flex', minHeight: '100vh' }}>
          ...
          <div className="auth-right" style={{
            ...
            <div className="auth-card" style={{ width: '100%', maxWidth: 400 }}>
              ...
              {/* ── Google Sign-In FIRST — easiest on mobile ── */}
              <button
                type="button"
                ...
                style={{
                  ...
                  gap: '0.75rem', padding: '1rem 1.5rem', borderRadius: 12,
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', margin: '1.25rem 0' }}>
                ...
                <span style={{ fontSize: '0.8rem', color: 'var(--on-surface-variant)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em' }}>or use email</span>
                <div style={{ flex: 1, height: 1, background: 'var(--outline-variant)' }} />
              </div>
